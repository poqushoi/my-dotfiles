...
-- Add both absolute and relative numbers
...
--]]
  ...
  require 'custom.plugins.workspace.telescope.telescope',
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>dl', '<CMD>Telescope diagnostics<CR>', 'Show diagnostics list in Telescope')
  ...
  { -- Autocompletion
    ...
    dependencies = {
      ...
      {
        'L3MON4D3/LuaSnip', -- Allows to move across snippets
        build = (function()
    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = { -- Define order of how snippets appear
          {
            name = 'lazydev',
          ...
          { name = 'buffer' }, -- text within current text buffer
          { name = 'path' }, -- path
        },
      }
    end,
